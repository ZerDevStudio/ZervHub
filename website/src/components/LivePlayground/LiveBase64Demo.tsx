...
export const LiveBase64Demo: React.FC = () => {
  ...
  const [input, setInput] = useState('ZenDev v2.5.5: Hızlı, Güvenli ve Özgür Geliştirici Paketi! 🚀');
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 text-xs font-mono">
        ...
        <div className="flex items-center gap-1.5 ml-auto">
          ...
          <button
            onClick={() => loadPreset('ZenDev v2.5.5: Hızlı, Güvenli ve Özgür Geliştirici Paketi! 🚀', 'encode')}
          ...
          <button
            onClick={() => loadPreset('WmVuRGV2IHYyLjUuNTogSMSxemzEsSwgR8O8dmVubGkgdmUgw5Z6Z8O8ciBHZWxpxZ90aXJpY2kgUGFrZXRpISDwn5qA', 'decode')}
