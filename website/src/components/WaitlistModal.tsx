          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300 mt-2 leading-relaxed">
                {isTr
                  ? 'E-posta adresinizi bırakın, ZenDev v2.5.6 ömür boyu lisansında geçerli anlık %20 indirim kupon kodunu hemen kazanın.'
                  : 'Enter your email to receive an instant 20% off coupon code redeemable at checkout for ZenDev v2.5.6 lifetime license.'}
              </p>
            </div>
