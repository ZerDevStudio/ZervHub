...
export const ZENDEV_TOOLS: ToolItem[] = [
  ...
  // ── YAZILIM GELİŞTİRİCİ: YENİ ELEVASYON STÜDYOLARI (v2.5.6) ──
  {
    id: 'jwt-studio',
    name: 'JwtStudio',
    category: 'developer',
...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answerTr: 'Klasik Electron uygulamaları arka planda tam bir Chromium ve Node.js motoru çalıştırarak 400-600 MB RAM tüketir. ZenDev v2.5.6 ise Windows yerel WebView2 ve Rust işletim sistemi köprüsü kullanarak yalnızca < 26 MB RAM harcar ve 0.35 saniyede açılır.',
    answerEn: 'Traditional Electron apps bundle a full Chromium browser and consume 400-600 MB RAM. ZenDev v2.5.6 leverages Windows native WebView2 and a Rust backend, consuming only < 26 MB RAM with 0.35s boot latency.'
  },
  {
    id: 'faq-3',
    category: 'license',
